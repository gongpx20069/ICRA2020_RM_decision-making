...
def random_ob():
    ...
    ob.append(random.randint(0,750))
    ob.append(random.randint(0,45))
...
if __name__ == '__main__':
    ...
    if os.path.exists('./PPO_blue_pre.pth'):
        network.load_state_dict(torch.load('./PPO_blue_pre.pth', map_location='cpu'))
    ...
    for i in range(1000):
        ...
        if i % 20 == 0:
            ...
            torch.save(network.state_dict(), './PPO_blue_pre.pth')
